...
public class WaterType extends Monster {
	public WaterType(String n, int m, int base){
        ...
        System.out.printf("Congratulations! You just adopted a Water type pokemon! The following are the stats:%n%s%nMax HP: %.2f %nAttack: %.2f%nDefense: %.2f%n%n", this.getName(), this.getMaxHP(), this.getAtk(), this.getDef());
    }
